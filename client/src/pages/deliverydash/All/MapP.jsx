    ...
    <div>
      ...
      >
        {pickups &&
          pickups.map((crop) => (
            <Marker
              latitude={Number(crop.address.split(",")[1])}
              longitude={Number(crop.address.split(",")[0])}
            >
              <button
                style={{
                  background: "none",
        ...
        {selectedCrop ? (
          <Popup
            latitude={Number(selectedCrop.address.split(",")[1])}
            longitude={Number(selectedCrop.address.split(",")[0])}
            onClose={() => {
